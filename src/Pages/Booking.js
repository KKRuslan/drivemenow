...
const BookingPage = () => {
  ...
  useEffect(() => {
    axios.get(`http://localhost:3001/api/cars/${carId}`)
      .then(response => {
  ...
  return (
    <Grid item xs={12} sm={6} md={4}>
      <Box minHeight="100vh" display="flex" alignItems="center" justifyContent="center" bgcolor="transparent">
        <Card sx={{ maxWidth: '100%', background: 'transparent', boxShadow: '2px 2px 6px rgba(0, 0, 0, 0.4)',  height: '100%' }}>
          <CardMedia
            component="img"
            height="200"
          ...
          />
          <CardContent>
            <Typography gutterBottom variant="h5" component="div" color="white" align="center" mb={2}>
              {carData.name}
            </Typography>
            <Typography variant="h6" color="primary" align="center" mb={2} sx={{ color: 'white', ml: 1 }}>
              {carData.price}$ /день
            </Typography>
              ...
              {isBookingComplete ? (
                <div className="modal">
                  <div className="modal-content">
                    ...
                    <Button size="small" variant="contained" color="primary" onClick={() => setIsBookingComplete(false)}>
                      Закрити
                    </Button>
                  </div>
                </div>
                ...
                showPayPalButton ? (
                  ...
                  <Button size="small" variant="contained" color="primary" onClick={handleBookNow}>
                    Забронювати
                  </Button>
                )
              )}
